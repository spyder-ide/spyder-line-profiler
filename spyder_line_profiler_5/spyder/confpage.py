...
from .widgets import SpyderLineProfiler5Widget
_ = get_translation("spyder_line_profiler_5.spyder")


class SpyderLineProfiler5ConfigPage(PluginConfigPage):
    ...
    def setup_page(self):
        ...
        results_label2 = QLabel(SpyderLineProfiler5Widget.DATAPATH)
