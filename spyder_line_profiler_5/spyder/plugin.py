...
# Local imports
from spyder_line_profiler_5.spyder.confpage import SpyderLineProfiler5ConfigPage
...
class SpyderLineProfiler5(SpyderDockablePlugin):
    """
    Spyder Line Profiler 5 plugin.
    """

    NAME = "spyder_line_profiler_5"
    REQUIRES = [Plugins.Editor]
    OPTIONAL = []
    TABIFY = Plugins.Help
    WIDGET_CLASS = SpyderLineProfiler5Widget
    CONF_SECTION = NAME
    CONF_WIDGET_CLASS = SpyderLineProfiler5ConfigPage
